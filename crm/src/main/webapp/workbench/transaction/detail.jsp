<%@ page import="com.shantouxzk.crm.settings.domain.DicValue" %>
<%@ page import="java.util.List" %>
<%@ page import="java.util.Map" %>
<%@ page import="com.shantouxzk.crm.workbench.domain.Tran" %>
...
<div style="position: relative; left: 40px; top: -30px;">
    ...
    <div style="position: relative; height: 50px; width: 250px;  top: -72px; left: 700px;">
        <button type="button" class="btn btn-default" onclick="window.location.href='workbench/transaction/edit.html';">
...
<div style="position: relative; left: 40px; top: -50px;">
        ...
        if ("0".equals(currentPossibility)) {
            ...
            for (int i = 0; i < dvList.size(); i++) {
                ...
                if ("0".equals(listPossibility)) {
                    if (listStage.equals(currentStage)) {//红叉-----------
    %>
    ...
    <%
        ...
        for (int i = 0; i < dvList.size(); i++) {
            ...
            String listStage = dv.getValue();
            String listPossibility = pMap.get(listStage);
            if ("0".equals(listPossibility)) {//黑叉
    %>
    <span id="<%=i%>" onclick="changeStage('<%=listStage%>','<%=i%>')"
          class="glyphicon glyphicon-remove mystage"
          data-toggle="popover" data-placement="bottom"
